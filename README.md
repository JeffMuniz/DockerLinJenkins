Adicionar loja ao readme



## K8s & Elk - Elastic Logstach Kibana yaml kubernetes deploy
eks-aws-spinner   - Has AWS services eks

elasticLogstashtKibana  - Has a gathering of Elastic Logstash Kibana using beats (brought all together in a k8s clusters)

k8s-infra and root - Constructing k8s directly via yaml and some architecture and desings (Rancher and Helm helpers as well)

flyway-db and Storage Classes examples, pv and pvc

#GitGuardian #SonarQube #CodeCov #Dependabot
$To be Validated JetBrains BFG Fortify and some other thousands that surges every single day :D

#Arch from a macro view (Do you see k8s here? It's hiding in a plain sight)

![My Image](k8s-arch.jpeg)

#Arch from a macro EKS (AWS)

![My Image](solucao-istio-aws.jpg)

#We're all allways learning

![My Image](learn-k8s.png)




![My Image](comoSerDevops.jfif)
![My Image](learn-k8s.png)
![My Image](k8s-arch.jpeg)
![My Image](solucao-istio-aws.jpg)
